# [12.8.0](https://github.com/tidev/titanium_mobile/compare/12_7_X...12.8.0) (TBD)

## About this release

Titanium SDK 12.8.0 is a minor release of the SDK, introducing the new StackView component for modern stack-based layouts.

## Features

### Multiple platforms

* **[Ti.UI.StackView]** Added new StackView component for modern stack-based layouts
  * Cross-platform implementation using native UIStackView (iOS) and LinearLayout (Android)
  * Support for vertical and horizontal axis orientations
  * Multiple distribution modes: fill, fillEqually, fillProportionally, equalSpacing, equalCentering
  * Flexible alignment options: fill, leading, center, trailing, firstBaseline, lastBaseline
  * Dynamic view management with addArrangedSubview(), removeArrangedSubview(), insertArrangedSubview()
  * Custom spacing control with setCustomSpacing() method
  * Layout margins support with layoutMargins and layoutMarginsRelativeArrangement properties
